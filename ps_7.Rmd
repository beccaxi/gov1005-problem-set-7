...
conservatism. One such reason may be that a subset of the older democratic m
embers of the 116th Congress were influenced by a common, more liberal political
ideology, perhaps even in their youth, and that democratic ideology has become 
relatively less liberal since.
...
# variable or something else, or the function will not be able to find
...
dem <- dem %>% 
  ...
  select(congress, reg_results) 

# Use map_dbl() to pull the estimate for age from each congress, as well as the standard error, which you can use to create an upper and lower column for the 95% confidence interval (see PPBDS 10.2.2 for help on the standard error method of calculating confidence intervals).
